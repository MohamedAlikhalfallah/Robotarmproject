...
bool scene_graph_interfaces__msg__fun_object3_d_bounding_box_list__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scene_graph_interfaces.msg._fun_object3_d_bounding_box_list.FunObject3DBoundingBoxList", full_classname_dest, 86) == 0);
  }
  scene_graph_interfaces__msg__FunObject3DBoundingBoxList * ros_message = _ros_message;
  {  // header
  ...
  {  // bbox
    ...
    if (!scene_graph_interfaces__msg__FunObject3DBoundingBox__Sequence__init(&(ros_message->bbox), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create scene_graph_interfaces__msg__FunObject3DBoundingBox__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    scene_graph_interfaces__msg__FunObject3DBoundingBox * dest = ros_message->bbox.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!scene_graph_interfaces__msg__fun_object3_d_bounding_box__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of FunObject3DBoundingBoxList */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("scene_graph_interfaces.msg._fun_object3_d_bounding_box_list");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FunObject3DBoundingBoxList");
  ...
  {  // bbox
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = scene_graph_interfaces__msg__fun_object3_d_bounding_box__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
