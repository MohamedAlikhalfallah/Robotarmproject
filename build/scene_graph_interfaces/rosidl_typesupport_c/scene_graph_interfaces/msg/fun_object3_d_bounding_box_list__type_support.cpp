...
static const _FunObject3DBoundingBoxList_type_support_symbol_names_t _FunObject3DBoundingBoxList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scene_graph_interfaces, msg, FunObject3DBoundingBoxList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scene_graph_interfaces, msg, FunObject3DBoundingBoxList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, scene_graph_interfaces, msg, FunObject3DBoundingBoxList)() {
  return &::scene_graph_interfaces::msg::rosidl_typesupport_c::FunObject3DBoundingBoxList_message_type_support_handle;
}
