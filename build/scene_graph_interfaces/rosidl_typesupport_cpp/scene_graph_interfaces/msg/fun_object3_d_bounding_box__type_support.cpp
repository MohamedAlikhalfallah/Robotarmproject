...
static const _FunObject3DBoundingBox_type_support_symbol_names_t _FunObject3DBoundingBox_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scene_graph_interfaces, msg, FunObject3DBoundingBox)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scene_graph_interfaces, msg, FunObject3DBoundingBox)),
  }
};
...
{
  return &::scene_graph_interfaces::msg::rosidl_typesupport_cpp::FunObject3DBoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, scene_graph_interfaces, msg, FunObject3DBoundingBox)() {
  return get_message_type_support_handle<scene_graph_interfaces::msg::FunObject3DBoundingBox>();
}
